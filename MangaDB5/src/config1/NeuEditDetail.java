...
//		int isActiveInsertImage = Main.getActive("insertImage");
//		
//		if(isActiveInsertImage == 1){
//			ClassLoader classLoader = NeuEditDetail.class.getClassLoader();
//			
//			try {
//				Class<?> plugin = classLoader.loadClass("isp1415.ar.plugins.insertImage");
//				Constructor<?>[] cons = plugin.getDeclaredConstructors();
//				Object instance = cons[0].newInstance("Cover-Bild");
//							
//				image = (JLabel) plugin.getMethod("setImage").invoke(instance);
//								
